package com.HuynhDuyKhanh.example05.entity;
...
public class User {
    ...
    @Size(min = 10, max = 12, message = "Mobile Number must be exactly 10 digits long")
    @Pattern(regexp = "^(\\+?84|0)\\d{9}$", message = "Mobile Number must be a valid Vietnamese phone number")
