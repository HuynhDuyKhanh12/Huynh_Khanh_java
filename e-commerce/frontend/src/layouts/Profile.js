                ...
                <div className="card-body">
                  {userInfo && (
                    <figure className="icontext">
                      <div className="icon">
                        <img className="rounded-circle img-sm border" src={userInfo.image || "http://localhost:8081/api/public/products/image/2.jpg"} alt="Ảnh đại diện" />
                      </div>
                      <div className="text">
                              ...
                              <tbody>
                                {recentOrder.orderItems.map((item) => (
                                  <tr key={item.orderItemId}>
                                    <td width="65">
                                      <img 
                                        src={`http://localhost:8081/api/public/products/image/${item.product.image}`} 
